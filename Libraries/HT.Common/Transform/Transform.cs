...
namespace HT.Common.Transform
{
    ...
    public static partial class Transform
    {
        ...
        {
            return ConvertValue<DateTime>(value);
        }
        ...
        public static T ConvertValue<T>(object value)
        {
            ...
            {
                return (T)Enum.Parse(typeof(T), ConvertValue<string>(value), true);
            }
            ...
            switch (typeof(T).ToString())
            {
                ...
                case "System.Byte[]":
                    try
                    {
                        return (T)value; //attempt simple cast
                    }
                    catch
                    {
        ...
        {
            return ConvertValue<Guid>(value);
        }
        ...
        public static int ToInt32(string columnName, DataRow dr)
        {
        ...
        /// <param name="dr">DataReader containing field to convert</param>
        /// <returns>Converted value or default(Int32) if not found</returns>
        public static int ToInt32(string columnName, IDataReader dr)
        {
            return ToInt32(dr[columnName]);
        }
        /// <summary>
        ...
        {
            return ConvertValue<long>(value);
        }
        ...
        public static long ToInt64(string columnName, DataRow dr)
        {
        ...
        public static bool ToBoolean(string columnName, DataRow dr)
        {
        ...
        /// <param name="dr">DataReader containing field to convert</param>
        /// <returns>Converted value or default(Boolean) if not found</returns>
        public static bool ToBoolean(string columnName, IDataReader dr)
        {
            return ToBoolean(dr[columnName]);
        ...
        {
            return new ASCIIEncoding().GetBytes(strToConvert);
        }
